...
(() => {
  ...
  // levelLength is capped well under 45s for every tier (survived-time
  // ms) so a level always clears in under 45 seconds.
  const RANGER_TIERS = {
    simple:    { levelLength: 28000, spawnStart: 1400, spawnEnd: 700, speedStart: 81,  speedEnd: 150, weaverAt: 0.30, hunterAt: 0.70 },
    moderate:  { levelLength: 34000, spawnStart: 1000, spawnEnd: 420, speedStart: 104, speedEnd: 196, weaverAt: 0.20, hunterAt: 0.55 },
    difficult: { levelLength: 40000, spawnStart: 750,  spawnEnd: 280, speedStart: 127, speedEnd: 242, weaverAt: 0.10, hunterAt: 0.40 },
  };
